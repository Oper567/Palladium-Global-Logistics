...
// Improve SEO and browser tab appearance for new client onboarding
export const metadata: Metadata = {
  title: "Open Account | Palladium Global Logistics",
  description: "Register to access live logistics pricing, fleet availability, and instant dispatch services.",
};

export default function SignUpPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-brand-light relative overflow-hidden w-full py-12">
      
      {/* Brand Background Arc - Identical to SignIn for seamless transitions */}
